...
import { resolveOfficialGroup } from './src/modules/planilla-asistida/application/groupResolver'
...
async function analyze() {
  ...
  const slotCountsByGroup: Record<string, number> = (slots || []).reduce((acc: any, slot: any) => {
