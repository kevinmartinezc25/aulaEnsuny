...
export function TeacherSettingsScreen() {
  ...
  useEffect(() => {
    async function loadProfile() {
      ...
      // Verificar si hay sesión demo activa en la cookie (solo en modo demo)
    ...
    <div className="mx-auto max-w-5xl space-y-8 text-left">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
          Administra tu perfil de docente, preferencias y ajustes de seguridad.
        </p>
      </div>
              ...
              <div className="p-6 sm:p-8 space-y-8">
                ...
                {loading ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Rol Institucional</label>
                      <input
                        type="text"
                        value={roleName}
                        readOnly
                    ...
                    <div className="space-y-2 sm:col-span-2">
                      ...
                      <textarea
                        ...
                        placeholder="Escribe tu perfil docente, asignaturas o áreas de interés..."
            ...
            >
              <div className="p-6 sm:p-8 space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    { id: 'n1', title: 'Nuevas Entregas de Tareas', desc: 'Avisarme cuando un estudiante realice una entrega o responda a una tarea.', defaultChecked: true },
                    { id: 'n2', title: 'Participación en Foros', desc: 'Recibir notificaciones de nuevos hilos o respuestas en foros de discusión.', defaultChecked: true },
                    { id: 'n3', title: 'Comentarios Académicos', desc: 'Recibir avisos de nuevas consultas de estudiantes de mis cursos.', defaultChecked: true },
                    { id: 'n4', title: 'Anuncios Institucionales', desc: 'Avisar cuando se publique una noticia importante en el colegio.', defaultChecked: true },
                  ].map((notif) => (
