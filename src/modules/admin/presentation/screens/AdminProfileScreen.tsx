...
export function AdminProfileScreen() {
  ...
  const handleSaveNotifications = () => {
    setIsSaving(true)
    if (typeof window !== 'undefined') {
      const uId = userId || 'demo-admin-id'
    ...
    <div className="mx-auto max-w-5xl space-y-8 text-left">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
          Administra tu perfil de administrador, preferencias y ajustes de seguridad.
        </p>
      </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2 sm:col-span-2">
                      ...
                      <textarea
                        ...
                        placeholder="Escribe tu perfil administrador, asignaturas o áreas de interés..."
            ...
            >
              <div className="p-6 sm:p-8 space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    { id: 'n1', title: 'Nuevas Entregas de Tareas', desc: 'Avisarme cuando un estudiante realice una entrega o responda a una tarea.' },
                    { id: 'n2', title: 'Participación en Foros', desc: 'Recibir notificaciones de nuevos hilos o respuestas en foros de discusión.' },
                    { id: 'n3', title: 'Comentarios Académicos', desc: 'Recibir avisos de nuevas consultas de estudiantes de mis cursos.' },
                    { id: 'n4', title: 'Anuncios Institucionales', desc: 'Avisar cuando se publique una noticia importante en el colegio.' },
                  ].map((notif) => (
