...
import { GroupOverlapRule, TeacherOverlapRule, TimeOffRule, GroupNoGapsRule, SubjectMaxHoursPerDayRule, TeacherRequiredRule, SubjectOncePerDayRule, SubjectRulesRule, MultiTeacherSameSlotRule } from './rules/HardConstraints';
